...
Until Orbit Navigator reaches 1.0, only the newest published release is
supported with security fixes. Older builds should be upgraded rather than
...
coordinate disclosure after a fix is available. A permanent private security
contact is a required gate before applying for public code signing.
